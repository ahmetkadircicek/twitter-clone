...
//  Twitter
//
//  Created by Ahmet on 23.06.2023.
//
...
class OnboardingViewController: UIViewController {
    ...
    private let welcomeLabel: UILabel = {
       let label = UILabel()
        ...
        label.text = "See what's happenening in the world right now!"
    ...
    private func configureConstraints() {
        ...
        let prompLabelConstraints = [
            promptLabel.leadingAnchor.constraint(equalTo: createAccountButton.leadingAnchor, constant: 60),
            promptLabel.bottomAnchor.constraint(equalTo: createAccountButton.bottomAnchor, constant: 30)
        ]
        ...
        NSLayoutConstraint.activate(prompLabelConstraints)
